...
public class ColorPickerView extends View{
	...
	private String		mAlphaSliderText = "Alpha";	 //$NON-NLS-1$
	...
	public ColorPickerView(Context context, AttributeSet attrs, int defStyle) {
		...
		mAlphaSliderText = context.getText(R.string.color_picker_alpha).toString();
		init();
	}
	...
	private void drawAlphaPanel(Canvas canvas){
		...
		if(mAlphaSliderText != null && mAlphaSliderText!= ""){ //$NON-NLS-1$
